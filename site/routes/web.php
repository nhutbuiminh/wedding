...
//dress-admin
Route::get('admin/dress/index', 'DressesController@index')->name('dress.index');//->middleware('checkUser');
...
Route::get('admin/edit/{id}', 'DressesController@edit')->name('adress.edit')->middleware('checkUser');
