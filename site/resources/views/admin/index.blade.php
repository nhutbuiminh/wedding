                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Sản phẩm</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="add-product.blade.php">Thêm mới</a></li>
                                <li><a href="list-product.blade.php">Quản lý</a></li>
                                <li><a href="cat-product.blade.php">Danh mục sản phẩm</a></li>
                            </ul>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card blog-widget">
                            <div class="card-body">
                                <div class="blog-image"><img src="{{asset('images/big/img1.jpg')}}" alt="img" class="img-responsive"/></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <img class="" src="
                            {{asset('images/background/weatherbg.jpg')}}" alt="Card image cap">
